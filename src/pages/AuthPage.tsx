  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-md panel-gradient border border-border rounded-lg p-8">
          <h2 className="font-orbitron text-foreground text-xl font-bold text-center mb-6">
